...
export const ALL_DEMO_USERS = [
  ...
  { id: 2, name: 'Александр', age: 26, img: PlaceHolderImages[1].imageUrl, hint: PlaceHolderImages[1].imageHint, online: true, distance: 3, match: 95, city: 'Москва', zodiac: 'Овен', interests: ['Путешествия', 'Кофе', 'Спорт'], bio: 'Всегда в движении. Ищу ту, кто разделит мою страсть к горам и кофе.', height: 185, goal: 'Серьезные отношения', gender: 'male', lookingFor: 'female' },
  { id: 4, name: 'Михаил', age: 28, img: PlaceHolderImages[3].imageUrl, hint: PlaceHolderImages[3].imageHint, online: false, distance: 5, match: 89, city: 'Москва', zodiac: 'Скорпион', interests: ['Музыка', 'Кофе', 'Фотография'], bio: 'Играю на гитаре, варю лучший эспрессо. Давай сходим на концерт?', height: 182, goal: 'Свидания', gender: 'male', lookingFor: 'female' },
  { id: 6, name: 'Артем', age: 25, img: PlaceHolderImages[5].imageUrl, hint: PlaceHolderImages[5].imageHint, online: true, distance: 4, match: 84, city: 'Москва', zodiac: 'Близнецы', interests: ['Спорт', 'Музыка', 'Путешествия'], bio: 'Кодю днем, бегаю вечером. Люблю умные разговоры.', height: 178, goal: 'Новые друзья', gender: 'male', lookingFor: 'female' },
  { id: 8, name: 'Иван', age: 27, img: PlaceHolderImages[7].imageUrl, hint: PlaceHolderImages[7].imageHint, online: false, distance: 8, match: 91, city: 'Москва', zodiac: 'Стрелец', interests: ['Фотография', 'Путешествия', 'Спорт'], bio: 'Пейзажный фотограф. Мечтаю о поездке в Исландию.', height: 188, goal: 'Серьезные отношения', gender: 'male', lookingFor: 'female' },
  ...
  { id: 11, name: 'Дмитрий', age: 32, img: "https://picsum.photos/seed/person_man_11/600/800", hint: "man portrait", online: true, distance: 2, match: 92, city: 'Москва', zodiac: 'Телец', interests: ['Спорт', 'Кофе', 'Путешествия'], bio: 'Люблю активный отдых и продуктивные утра. Ищу серьезные отношения.', height: 184, goal: 'Серьезные отношения', gender: 'male', lookingFor: 'female' },
  { id: 12, name: 'Максим', age: 29, img: "https://picsum.photos/seed/person_man_12/600/800", hint: "man fashion", online: false, distance: 4, match: 86, city: 'Москва', zodiac: 'Козерог', interests: ['Музыка', 'Фотография', 'Спорт'], bio: 'Меломан и эстет. Люблю находить красоту в мелочах.', height: 179, goal: 'Свидания', gender: 'male', lookingFor: 'female' },
  { id: 13, name: 'Андрей', age: 31, img: "https://picsum.photos/seed/person_man_13/600/800", hint: "man professional", online: true, distance: 7, match: 83, city: 'Москва', zodiac: 'Весы', interests: ['Путешествия', 'Кофе', 'Музыка'], bio: 'Архитектор. Ищу вдохновение и интересного собеседника.', height: 181, goal: 'Новые друзья', gender: 'male', lookingFor: 'female' },
  { id: 14, name: 'Игорь', age: 24, img: "https://picsum.photos/seed/person_man_14/600/800", hint: "man fitness", online: true, distance: 1, match: 94, city: 'Москва', zodiac: 'Рак', interests: ['Спорт', 'Фотография', 'Путешествия'], bio: 'Жизнь — это приключение. Давай напишем свою историю вместе?', height: 176, goal: 'Серьезные отношения', gender: 'male', lookingFor: 'female' },
  { id: 15, name: 'Виктор', age: 35, img: "https://picsum.photos/seed/person_man_15/600/800", hint: "man intellectual", online: false, distance: 9, match: 81, city: 'Москва', zodiac: 'Дева', interests: ['Кофе', 'Музыка', 'Спорт'], bio: 'Спокойный, надежный, ценю уют и хороший джаз.', height: 183, goal: 'Свидания', gender: 'male', lookingFor: 'female' },
