        ...
        <div className="space-y-6 animate-in slide-in-from-bottom-8 duration-700">
          <form onSubmit={handleRegister} className="space-y-4">
            ...
            <Button 
              type="submit" 
              disabled={isLoading}
              className="w-full h-14 rounded-2xl gradient-bg text-white font-black uppercase tracking-widest shadow-2xl shadow-primary/40 hover:scale-[1.02] transition-all active:scale-95 border-0"
            >
