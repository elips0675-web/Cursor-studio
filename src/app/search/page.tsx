            ...
            <div className="bg-gradient-to-br from-primary/5 to-orange-500/5 p-6 rounded-[2.5rem] mb-8 text-left border border-primary/10 relative overflow-hidden group shadow-sm">
              ...
              {loadingAi ? (
                <div className="flex items-center gap-3 text-[11px] text-muted-foreground">
                  ...
                  <span className="animate-pulse">{language === 'RU' ? 'Анализируем...' : 'Analyzing...'}</span>
                </div>
              ) : (
                <p className="text-[12px] leading-relaxed text-foreground/80 italic font-medium relative z-10">
                  {compatibility}
                </p>
              )}
            </div>
